...
const STEPS = [
  { id: 'sepa', title: 'SEPA', label: '1. SEPA 통과 확인', desc: '시스템이 제시한 SEPA 판정과 미확인 데이터를 읽었고, 실패 조건이 없는 경우에만 계획을 저장합니다.' },
  { id: 'risk', title: 'Risk', label: '2. 리스크 동의', desc: '총 자본의 1%만 위험에 노출하며, 산출된 수량을 초과하지 않겠습니다.' },
  { id: 'entry', title: 'Entry', label: '3. 진입 규율', desc: '20일 고점 돌파 가격에 도달하기 전에는 예측 진입하지 않겠습니다.' },
  { id: 'stoploss', title: 'Stop', label: '4. 손절 규율', desc: '지정된 손절가에 도달하면 즉시 청산하고 손실을 확대하지 않겠습니다.' },
  { id: 'exit', title: 'Exit', label: '5. 청산 규율', desc: '추세가 유지되는 동안 조기 청산하지 않고, 사전에 정한 출구 기준을 따르겠습니다.' },
  { id: 'psychology', title: 'Mind', label: '6. 심리 점검', desc: '복수심, 조급함, 손실 만회 욕구가 아닌 차분한 상태에서만 실행하겠습니다.' },
];
    ...
    <Card>
      <div className="mb-5">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-400">
          SEPA가 Fail이면 체크리스트 첫 단계와 저장 버튼이 잠깁니다.
        </p>
      </div>
