  ...
  try {
    ...
    for (const market of markets) {
      ...
      const mockData = {
        ...
        ftd: { status: 'PASS' as const, value: 'Confirmed', threshold: 'Price > 1.2% & Vol > Prev', description: 'Follow-Through Day 확인됨', label: 'FTD', unit: 'status', source: 'yahoo' },
      ...
      const aiRes = await generateMarketInsight({
        ...
        metrics: {
          ...
          distribution: mockData.liquidity,
          ftd: mockData.ftd,
          newHighLow: mockData.newHighLow,
          sectorRotation: mockData.sectorRotation,
