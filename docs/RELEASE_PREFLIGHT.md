...
- `infra/release/production-scheduler-manifest.json` declares all 47 production
...
Add `--base-url=https://mttcs.vercel.app` to check all 47 production job URLs.
...
- `vercel.cronCount: 0`
- `scheduler.jobCount: 47`
- `live.checkedJobCount: 47`
- `live.statusCounts.401: 47`
