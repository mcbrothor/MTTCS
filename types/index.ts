...
export interface VcpAnalysis {
  ...
  pivotAgeDays: number | null;
  pivotKind: 'VCP_PIVOT' | 'HIGH_TIGHT_FLAG' | 'RECENT_HIGH_REFERENCE' | null;
  referenceHighPrice: number | null;
...
export type RecommendationTier = 'Recommended' | 'Action' | 'IB Review' | 'Watch' | 'Partial' | 'Low Priority' | 'Error';
...
export interface ScannerResult extends ScannerConstituent {
  ...
  entrySource?: VcpAnalysis['entrySource'] | null;
