...
Locator: locator('text=/현금 비중|방어적|신규 진입 중단/').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/현금 비중|방어적|신규 진입 중단/').first()
...
- navigation:
  ...
  - text: "S&P500 -- -- KIS NASDAQ -- -- KIS KOSPI -- -- KIS KOSDAQ -- -- KIS USD/KRW -- -- Yahoo Last Updated: 2026.05.24. 01:10:35"
  - link "오늘":
    - /url: /
  - link "시장 분석":
    - /url: /master-filter
