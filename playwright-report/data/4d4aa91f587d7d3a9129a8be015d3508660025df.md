...
- Name: edge-cases.spec.ts >> Wave 6: Edge Cases (심화 테스트) >> EDGE-02: 매매 계획 에지 케이스 — SEPA Fail 시 저장 차단
- Location: tests/e2e/edge-cases.spec.ts:55:7
...
Locator: locator('text=Fail').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('text=Fail').first()
