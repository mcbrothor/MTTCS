...
export function mapMarketAnalysisToScannerResult(item: ScannerConstituent, analysis: MarketAnalysisResponse): ScannerResult {
  ...
  return withRecommendation({
    ...
    changePercent,
    adrPct,
    riskGate: analysis.riskPlan.riskGate ?? null,
    stopQuality: analysis.riskPlan.stopQuality ?? null,
    riskTotalShares: analysis.riskPlan.totalShares ?? null,
    riskEntryPrice: analysis.riskPlan.entryPrice ?? null,
    riskStopLossPrice: analysis.riskPlan.stopLossPrice ?? null,
