...
const tests = [
  ...
  'tests/capital-basis.test.mjs',
  'tests/risk-gate.test.mjs',
  'tests/master-filter-shock.test.mjs',
  'tests/master-filter-early-warning.test.mjs',
  'tests/pyramid-position-sizing.test.mjs',
  'tests/account-performance.test.mjs',
  ...
  'tests/kr-investor-flow.test.mjs',
  'tests/kr-risk-ranking.test.mjs',
  'tests/recommendation-policy-evaluation.test.mjs',
