...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    detail: '윌리엄 오닐의 Follow-Through Day 개념. 랠리 4일째 이후 +1.5% 이상 대거래량 상승 시 바닥 반전 신호.',
  },
  {
    code: 'distribution',
  ...
  },
  {
    ...
    alias: '시장 날씨',
    icon: '🌤️',
    oneLiner: '7개 지표 종합 — 75↑ 진입 가능 · 50~74 보류 · 50↓ 방어 우선',
    detail: `강한 반등 확인 여부·분산일 수·새 고점/새 저점 균형·200일선 위 종목 비율·강한 업종 수·지수 평균선 위치·시장 불안도 7개 항목 합산 (각 최대 20점, 총 140점 → 100점 만점 환산).

만점은 7개 지표가 동시에 최적 조건일 때 수학적으로 달성 가능한 정당한 결과이며 시스템 버그가 아닙니다.
단, 만점 자체는 "현재보다 더 좋아질 여지가 없다"는 통계적 의미이므로 평균 회귀 압력이 존재합니다.
만점 상태에서의 신규 진입은 추세 지속 가능성과 함께 과열 여부를 별도로 검토하십시오.
종합 시장 점수는 시장 환경 점수일 뿐, 단독으로 매수·매도 신호로 사용하지 마십시오.`,
  },
];
