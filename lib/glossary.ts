...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    alias: '시장 날씨 점수',
    icon: '🌤️',
    oneLiner: '7개 지표 종합 — 75↑ GREEN · 50~74 YELLOW · 50↓ RED',
    detail: `FTD 확인·분산일 수·신고가/신저가 비율·200MA 상회 종목 비율·섹터 Risk-On 수·추세 정렬·VIX 수준 7개 항목 합산 (각 최대 20점, 총 140점 → 100점 만점 환산).
...
Regime Score는 거시 환경 점수일 뿐, 단독으로 매수·매도 신호로 사용하지 마십시오.`,
  },
];
