...
try {
  ...
  assert.equal(repositoryStructure.scheduler.jobCount, 47);
  assert.equal(repositoryStructure.scheduler.scheduleMigrations.length, 6);
  assert.equal(repositoryStructure.scheduler.discoveredRouteCount, 19);
