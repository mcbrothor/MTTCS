...
try {
  ...
  assert.equal(repositoryStructure.scheduler.jobCount, 34);
  assert.equal(repositoryStructure.scheduler.scheduleMigrations.length, 3);
  assert.equal(repositoryStructure.scheduler.discoveredRouteCount, 16);
