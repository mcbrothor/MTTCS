...
for (let index = 0; index < 20; index += 1) {
  ...
  rows.push({ runDate, engineVersion: 'daily-top10-market-balanced-v1', averageExcessReturnPct: 0, averageMaePct: -3, lowerDecileReturnPct: -5, flowCoveragePct: null });
...
const bootstrapA = evaluation.pairedBootstrap({
  baseline: rows.filter((row) => row.engineVersion === 'daily-top10-market-balanced-v1'),
