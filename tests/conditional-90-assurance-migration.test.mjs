...
assert.ok(
  manifest.requiredMigrations.includes('supabase/migrations/20260803121000_assurance_service_hash_execution.sql'),
  'service hash execution correction must be release-gated',
);
