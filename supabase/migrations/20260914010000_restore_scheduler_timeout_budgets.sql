-- Restore the 280-second transport budget introduced by the recommendation barrier.
-- The closing-bet scheduler later replaced the shared functions and regressed other
-- jobs to 55 seconds. Preserve closing-bet at 240/300 seconds, and allow all other
-- jobs 280/290 seconds (request/collector), covering the 270-second route budget.
-- Only timeout policy changes; authentication, validation and run identity stay intact.
