...
-- Note: It might be named watchlist_ticker_unique or something else, let's use IF EXISTS.
-- Actually the CREATE TABLE had UNIQUE(ticker) which usually creates a constraint named table_column_key.
