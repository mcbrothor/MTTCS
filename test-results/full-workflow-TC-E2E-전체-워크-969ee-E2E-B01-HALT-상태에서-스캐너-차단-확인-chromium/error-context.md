...
- Name: full-workflow.spec.ts >> TC-E2E: 전체 워크플로우 통합 시나리오 >> 시나리오 B: 방어적 흐름 (RISK_OFF / HALT) >> E2E-B01: HALT 상태에서 스캐너 차단 확인
- Location: tests/e2e/full-workflow.spec.ts:121:9
...
Locator: locator('text=/HALT|차단|제한/').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=/HALT|차단|제한/').first()
...
- navigation:
  ...
  - text: "S&P500 -- -- KIS NASDAQ -- -- KIS KOSPI -- -- KIS KOSDAQ -- -- KIS USD/KRW -- -- Yahoo Last Updated: 2026.05.24. 01:25:45"
  - link "오늘":
    - /url: /
  - link "시장 분석":
    - /url: /master-filter
