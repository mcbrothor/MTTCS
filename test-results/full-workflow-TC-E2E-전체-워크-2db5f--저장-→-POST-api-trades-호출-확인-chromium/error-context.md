...
- Name: full-workflow.spec.ts >> TC-E2E: 전체 워크플로우 통합 시나리오 >> 시나리오 A: 정상 흐름 (RISK_ON + 강한 후보) >> E2E-A05: 계획 저장 → POST /api/trades 호출 확인
- Location: tests/e2e/full-workflow.spec.ts:57:9
