...
- Name: cp-01-morning-routine.spec.ts >> CP-01: 장 전 루틴 완주 >> 전체 루틴 완주: / → /master-filter → /scanner → /watchlist
- Location: tests/e2e/smoke/cp-01-morning-routine.spec.ts:99:7
  ...
  - button "Open Next.js Dev Tools" [ref=e22] [cursor=pointer]:
    - generic [ref=e25]:
      ...
      - generic [ref=e26]:
        ...
        - generic [ref=e28]: .
        - generic [ref=e29]: .
  - alert [ref=e30]: MTN - Mantori's Trading Navigator
```
