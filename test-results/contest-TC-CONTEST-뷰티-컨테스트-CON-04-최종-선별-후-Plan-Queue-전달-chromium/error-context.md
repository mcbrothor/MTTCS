...
- Name: contest.spec.ts >> TC-CONTEST: 뷰티 컨테스트 >> CON-04: 최종 선별 후 Plan Queue 전달
- Location: tests/e2e/contest.spec.ts:66:7
...
Call log:
  ...
  - waiting for locator('text=PROCEED')
