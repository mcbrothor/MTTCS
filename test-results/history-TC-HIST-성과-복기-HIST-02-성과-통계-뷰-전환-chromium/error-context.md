...
Locator: locator('div').filter({ hasText: /^총 PnL$/ }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('div').filter({ hasText: /^총 PnL$/ }).first()
...
- main:
  ...
  - text: 100.0% 누적 손익
  - button "누적 손익 설명"
  - text: +$800.00 평균 R-Multiple
  - button "평균 R-Multiple 설명"
  - text: 0.00R 매매 기대값
  - button "매매 기대값 설명"
  - text: 0.00R
  - heading "Discipline & Adherence" [level=3]
  - text: 평균 규칙 점수
  - button "평균 규칙 점수 설명"
  - text: 92.0pt 계획 준수율
  - button "계획 준수율 설명"
  ...
  - button "SEPA 통과율 설명"
  - text: 100.0%
  - heading "Exposure & Pipeline" [level=3]
  - text: 오픈 리스크
  - button "오픈 리스크 설명"
  - text: $0.00 진행 중 계획
  - button "진행 중 계획 설명"
  - text: "0"
  - heading "청산 사유별 성과" [level=3]
  - text: 목표가 도달 1건 (100.0%) 0.00R 승률 0.0%
  - heading "실수 태그 통계" [level=3]
  - paragraph: 완료된 매매 기준으로 빈도와 평균 R을 함께 봅니다.
  - text: 완료된 매매에 기록된 실수 태그가 아직 없습니다.
  - heading "미국 최근 매매 복기" [level=3]
